...
import { getAttachmentFileUrl } from '@/lib/repositories/attachments';

const cache = new Map<string, string>();
const inFlight = new Map<string, Promise<string>>();

export function useAttachmentFileUrl(storagePath: string | null | undefined) {
  ...
  useEffect(() => {
    ...
    const existing =
      ...
      getAttachmentFileUrl(storagePath).then(u => {
