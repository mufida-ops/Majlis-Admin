...
import { getBookCoverUrl } from '@/lib/repositories/books';

const cache = new Map<string, string>();
const inFlight = new Map<string, Promise<string>>();

export function useBookCoverImage(storagePath: string | null | undefined) {
  ...
  useEffect(() => {
    ...
    const existing =
      ...
      getBookCoverUrl(storagePath).then(u => {
